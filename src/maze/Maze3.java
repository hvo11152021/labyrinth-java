...
class MyPanel3 extends JPanel implements ActionListener{
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(c3.getCharacter3(), c3.getBlockX3() * 32, c3.getBlockY3() * 32, null);
        g.setFont(font);
    ...
    public void actionPerformed(ActionEvent e) {
        if (!complete && m.getMap(c3.getBlockX3(), c3.getBlockY3()).equals("e")) {
            complete = true;
            timer.stop();
    ...
    public class Al extends KeyAdapter{
        ...
        public void keyPressed(KeyEvent e){
            ...
            if (keyletter == KeyEvent.VK_W){
                if(!m.getMap(c3.getBlockX3(), c3.getBlockY3()-1).equals("w"))
                    c3.move(0, -1);
            }
            ...
            if (keyletter == KeyEvent.VK_A){
                if(!m.getMap(c3.getBlockX3()-1, c3.getBlockY3()).equals("w"))
                    c3.move(-1, 0);
            }
